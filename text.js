const textToShow = [
  ...
  "",
  "About:",
  "       Cybersecurity professional, ex startup founder, and art history geek.",
  "       On a quest to understand the world better. ",
  "       Side-quests include: learning Erlang, running half marathons, ",
  "       and enjoying life with the people I love.",
  "",
  "Current question I am thinking a lot about: ",
  "       Where do I want to live until I die?",
  "",
  "Goal:",
  ...
  "           4.) Stay fun.",
  "",
  "Currently working at Jane Street doing Cybersecurity.",
  "",
  "Used to be CEO at Plasmo, making browser extension developer tooling:",
